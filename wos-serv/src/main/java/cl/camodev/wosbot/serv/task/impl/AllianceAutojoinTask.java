...
public class AllianceAutojoinTask extends DelayedTask {
	...
	protected void execute() {
        ...
        AllianceAutojoinMode mode = AllianceAutojoinMode.fromString(profile.getConfig(EnumConfigurationKey.ALLIANCE_AUTOJOIN_MODE_STRING, String.class));
    ...
    public enum AllianceAutojoinMode {
        ALL_TROOPS,
        FORMATION;

        public static AllianceAutojoinMode fromString(String mode) {
            if (mode != null) {
                for (AllianceAutojoinMode m : AllianceAutojoinMode.values()) {
